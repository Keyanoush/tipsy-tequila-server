    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='tipsytequilaapi.customer')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='tipsytequilaapi.product')),
            ],
            options={
                'verbose_name': 'rating',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='tipsytequilaapi.product')),
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tipsytequilaapi.review')),
            ],
        ),
        migrations.CreateModel(
            name='ProductRating',
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tipsytequilaapi.customer')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='tipsytequilaapi.product')),
            ],
        ),
        migrations.CreateModel(
            name='OrderProduct',
